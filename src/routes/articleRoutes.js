...
import { createArticleValidator, paramValidator, updateArticleValidator } from "../middlewares/validators/articleValidator.js";
...
articleRouter.get("/articles/:id", ownerAdminArticle, auth, paramValidator, validator, getArticleById);
articleRouter.put("/articles/:id", ownerAdminArticle, auth, updateArticleValidator, validator, updateArticle);
articleRouter.delete("/articles/:id", ownerAdminArticle, auth, paramValidator, validator, deleteArticle);
